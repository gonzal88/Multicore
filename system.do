...
add wave -noupdate /system_tb/DUT/CPU/DP/check
add wave -noupdate -divider -height 50 DATAPATH
...
add wave -noupdate -divider -height 50 ALU
...
add wave -noupdate -divider -height 50 EXTENDER
...
add wave -noupdate -divider -height 50 {IF/ID STAGE}
...
add wave -noupdate -divider -height 50 {INSTR/EXE STAGE}
...
add wave -noupdate -divider -height 50 {EXE/MEM STAGE}
...
add wave -noupdate -divider -height 50 {MEM/WB STAGE}
...
WaveRestoreCursors {{Cursor 1} {378893 ps} 0}
...
update
WaveRestoreZoom {270267 ps} {396321 ps}
